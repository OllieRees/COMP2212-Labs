...
alex_table = listArray (0 :: Int, 2857)
  [ 0
  , 12
  , 12
  , 12
...
alex_check = listArray (0 :: Int, 2857)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 = (\p s -> TokenRotateRight p)
alex_action_1 = (\p s -> TokenRotateLeft p)
alex_action_2 = (\p s -> TokenForward p)
alex_action_3 = (\p s -> TokenObstacle p)
alex_action_4 = (\p s -> TokenIf p)
alex_action_5 = (\p s -> TokenThen p)
alex_action_6 = (\p s -> TokenElse p)
alex_action_7 = (\p s -> TokenMDLBoolVal p (convStr2Bool s))
alex_action_8 = (\p s -> TokenMDLBoolOp p s)
alex_action_9 = (\p s -> TokenMDLVar p (read s))
alex_action_10 = (\p s -> TokenMDLEnd p)
