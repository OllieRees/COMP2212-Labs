...
happyExpList = Happy_Data_Array.listArray (0,40) ([33760,256,0,1,15872,31752,16,32784,40,0,8,256,0,512,4220,0,0,33760,0,0,0,2,31744,16,2,57344,131,0,0
	])
...
action_9 (11) = happyShift action_21
...
action_22 (12) = happyShift action_24
...
happyReduction_7 (HappyTerminal (TokenMDLBoolVal _ happy_var_1))
	 =  HappyAbsSyn5
		 (BoolVal happy_var_1
	)
...
happyReduction_8 (HappyTerminal (TokenMDLVar _ happy_var_3))
...
happyReduction_9 (HappyTerminal (TokenMDLVar _ happy_var_2))
	_
	 =  HappyAbsSyn5
		 (Obstacle happy_var_2 Done
	)
