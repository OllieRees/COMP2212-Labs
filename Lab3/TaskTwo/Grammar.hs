...
happyExpList = Happy_Data_Array.listArray (0,59) ([17616,32,512,61440,1,0,13312,26641,34,190,16384,33043,550,1101,2202,4404,128,17616,0,32768,0,32769,3,7,4096,53279,68,124,0
	])
...
parseError ts 
  ...
  | otherwise = error ("Parse error at line " ++ (show line) ++ " and column " ++ (show col) ++ ".")
